              ...
              return (
                <tr>
                  ...
                  {state.selectedView === viewTypes.LIST && (
                    <td>
                      <RoleTag showIcon={false} role={item?.groups} />
                    </td>
                  )}
                  ...
                  <td className="d-flex gap-2 align-items-center">
                    <Widget
                      ...
                      props={{
                        children: <i class="bi bi-person-plus"></i>,
                    ...
                    <Widget
                      src="nearui.near/widget/Input.Button"
                      props={{
                        children: <i class="bi bi-arrow-counterclockwise"></i>,
                        size: "sm",
                        variant: "icon info outline",
                        onClick: () => {},
                      }}
  ...
  <Wrapper className="d-flex flex-column gap-4">
        ...
        {Object.keys(policy?.roles ?? {})?.map((role, i) => {
          return (
            <div
              key={i}
              className={`custom-tag ${
                RolesColor.find((item) => item.role === role)?.color
              }-bg`}
            >
              {role}
    ...
    {state.isLoading ? (
      ...
      <div>
        ...
        {state.selectedView === viewTypes.LIST && <Table tableData={UIData} />}
            ...
            {UIData?.map((item) => {
              return (
                <div className="ndc-card p-4 d-flex flex-column gap-2">
                  ...
                  <div className="mt-3">
                    <RoleTag showIcon={true} role={item?.groups} />
                  </div>
